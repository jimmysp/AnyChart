goog.provide('anychart.annotationsModule.ModSchiffPitchfork');
...
/**
 * ModSchiffPitchfork annotation.
 * @param {!anychart.annotationsModule.ChartController} chartController
 * @constructor
 * @extends {anychart.annotationsModule.AndrewsPitchfork}
 */
anychart.annotationsModule.ModSchiffPitchfork = function(chartController) {
  anychart.annotationsModule.ModSchiffPitchfork.base(this, 'constructor', chartController);
};
goog.inherits(anychart.annotationsModule.ModSchiffPitchfork, anychart.annotationsModule.AndrewsPitchfork);
anychart.annotationsModule.AnnotationTypes[anychart.enums.AnnotationTypes.MOD_SCHIFF_PITCHFORK] = anychart.annotationsModule.ModSchiffPitchfork;
...
//----------------------------------------------------------------------------------------------------------------------
/** @inheritDoc */
anychart.annotationsModule.ModSchiffPitchfork.prototype.type = anychart.enums.AnnotationTypes.MOD_SCHIFF_PITCHFORK;
 ...
 */
anychart.annotationsModule.ModSchiffPitchfork.prototype.SUPPORTED_ANCHORS = anychart.annotationsModule.AnchorSupport.THREE_POINTS;
...
//----------------------------------------------------------------------------------------------------------------------
/** @inheritDoc */
anychart.annotationsModule.ModSchiffPitchfork.prototype.drawThreePointsShape = function(x1, y1, x2, y2, x3, y3) {
  // new point
  var x1n = x1 + (x2 - x1) / 2;
  var y1n = y1 + (y2 - y1) / 2;
